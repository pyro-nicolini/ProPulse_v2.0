...
const Hero = () => {
  ...
  const { productos } = useShop(ShopProvider);
  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
      ...
      >
        <div className="carousel-wrapper">
          {destacados.map((p, i) => (
            <div
              ...
              style={{ backgroundImage: `url(${p.url_imagen})` }}
            >
        ...
        <button className="nav2-button nav2-prev" onClick={goPrev} aria-label="Anterior">
          ‹
        </button>
        <button className="nav2-button nav2-next" onClick={goNext} aria-label="Siguiente">
          ›
        </button>
